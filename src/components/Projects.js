...
const Projects = () => {
  ...
  const goToIpodMiniGithub = () => {
    window.open('https://github.com/yvrjbhatiya/ipod_mini');
  };

  const goToIpodMiniLiveDemo = () => {
    window.open('https://ipod-mini.vercel.app/');
  };
  ...
  return (
    <section id="projects">
      ...
      <div className="experience-details-container">
        <div className="about-containers">
          ...
          <div className="details-container color-container">
            ...
            <p>
              The Ecommerce Store, using React and Tailwind, offers responsive design, integrated APIs, and user-friendly product updates for a seamless experience.
            </p>
            <br />
          ...
          <div className="details-container color-container">
            ...
            <h2 className="experience-sub-title project-title">iPod Mini</h2>
            <p>
              iPod Mini, crafted with HTML, CSS, and JavaScript, features a
              virtual Click Wheel for navigation, music playback control, and
              customizable themes.
            </p>
            <br />
            <div className="btn-container">
              <button
                className="btn btn-color-2 project-btn"
                onClick={goToIpodMiniGithub}
              >
                Github
              </button>
              <button
                className="btn btn-color-2 project-btn"
                onClick={goToIpodMiniLiveDemo}
              >
                Live Demo
              </button>
            </div>
      ...
      <img src={ArrowIMG} alt="Arrow icon" className="arrow" onClick={() => window.location.href='./#contact'} />
    </section>
  );
}
